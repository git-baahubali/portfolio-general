...
function Name() {
    return (
        <div className="sm:flex justify-between mt-[8rem]  h-[600px] border-sky-950 border-0">
            <div className='flex flex-col w-1/2 justify-center items-start gap-7
                ...
                <h1 className='text-8xl font-extrabold'>Balaji Dasari</h1>
                <section className='text-gray-600'>
                    Full sack developer committed to
